...
- Claude Code **不得**在 15.5 范围内自行新增 `BizCode.SERVICE_UNAVAILABLE`、修改 `AllExceptionsFilter` 或对 ready 路径做特殊映射;若未来确需标准 HTTP 503,作为独立任务在 V1.2+ 立项,届时一并修订本节、`AGENTS.md` §17.5、`TASKS.md` §15.5 三处描述
